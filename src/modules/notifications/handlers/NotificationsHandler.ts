...
export const createNotification = async (data: {
    ...
    const { title, message, type, cover, data: notificationData } = data;
...
// Atualização completa de notificação (PUT)
export const updateNotification = async (notificationId: string, data: {
    title: string;
    message: string;
    type: string;
    cover?: string;
...
// Atualização parcial de notificação (PATCH)
export const patchNotification = async (notificationId: string, data: {
    title?: string;
    message?: string;
    type?: string;
    cover?: string;
