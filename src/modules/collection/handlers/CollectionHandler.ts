...
export const getCollection = async (
  ...
  const collectionWithMangaNames = {
    ...
    mangas: collection.collectionMangas.map((collectionManga) => {
      ...
      const translationInLanguage = manga.translations.find(
...
export const checkMangaInCollections = async (
  mangaId: string,
  userId: string,
  page: number,
  take: number
...
export const toggleMangaInCollection = async (
  collectionId: string,
  mangaId: string,
  userId: string
) => {
...
export const searchCollectionsByName = async (
  query: string,
  userId: string,
  page = 1,
  take = 10
